...
Unmapped values are skipped; duplicate keys are last-wins (matching `serde_json` and typical backend parsers), and trailing non-whitespace content after the document blocks promotion.
