...
//! Tests for the iterative request router origin-aware failover example.
...
#[test]
fn upstream_429_triggers_failover() {
    ...
    let config = super::load_example_config(
        "traffic-management/iterative-request-router-origin-failover.yaml",
        proxy_port,
    ...
    assert_eq!(status, 200, "upstream 429 should trigger failover");
    assert_eq!(body, "fallback-ok", "should get fallback response");
}

#[test]
fn primary_200_no_failover() {
