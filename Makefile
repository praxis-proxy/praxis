...
.PHONY: all build release check clean \
	...
	test-fuzzing test-security test-security-suite test-resilience test-smoke \
	bench \
...
test-security: audit test-security-suite
...
help:
	...
	@echo "  test-security        audit + security test suite"
