...
| [to-chat-completions.yaml](configs/ai/openai/responses/to-chat-completions.yaml) | Transforms `/v1/responses` request and non-streaming response bodies for Chat Completions-compatible inference backends |
